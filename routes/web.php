...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/admin/orientation-overalls', [orientationOverallController::class, 'index'])->name('admin.orientation-overalls');
    ...
    Route::get('/admin/audit', [AuditTrailController::class, 'index'])->name('admin.audit');
    ...
    Route::post('/admin/orientation-overalls', [orientationOverallController::class, 'store'])->name('admin.orientation-overalls.store');
    // update data
    ...
    Route::put('/admin/orientation-overalls/{id}', [orientationOverallController::class, 'update']);
    ...
    Route::get('/admin/orientation-overalls/{id}', [orientationOverallController::class, 'edit']);
    ...
    Route::get('/get-provinces-by-region', [orientationOverallController::class, 'getProvincesByRegion']);
    Route::get('/get-city-municipality-by-province', [orientationOverallController::class, 'getCityMunicipalityByProvince']);
    // delete data
    ...
    Route::delete('/admin/orientation-overalls/{id}', [orientationOverallController::class, 'delete']);
    // profile
